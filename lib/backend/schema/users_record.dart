...
class UsersRecord extends FirestoreRecord {
  ...
  // "productFavorites" field.
  List<DocumentReference>? _productFavorites;
  List<DocumentReference> get productFavorites => _productFavorites ?? const [];
  bool hasProductFavorites() => _productFavorites != null;
  ...
  void _initializeFields() {
    ...
    _productFavorites = getDataList(snapshotData['productFavorites']);
    _isAdmin = snapshotData['isAdmin'] as bool?;
    _isShop = snapshotData['isShop'] as bool?;
  }
...
class UsersRecordDocumentEquality implements Equality<UsersRecord> {
  ...
  bool equals(UsersRecord? e1, UsersRecord? e2) {
    ...
    return e1?.userCity == e2?.userCity &&
        ...
        listEquality.equals(e1?.productFavorites, e2?.productFavorites) &&
