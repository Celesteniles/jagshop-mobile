...
class AppStateNotifier extends ChangeNotifier {
  ...
  JAGShopAuthUser? initialUser;
  JAGShopAuthUser? user;
  ...
  void update(JAGShopAuthUser newUser) {
    final shouldUpdate =
...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          name: 'DetailsPageCopy',
          path: '/detailsPageCopy',
          asyncParams: {
        ...
        FFRoute(
          ...
          path: '/storePage',
          asyncParams: {
            'store': getDoc(['stores'], StoresRecord.fromSnapshot),
          },
        ...
        FFRoute(
          ...
          path: '/modePaiementPage',
          builder: (context, params) => ModePaiementPageWidget(),
        ),
        FFRoute(
          name: 'OnboardingCopy',
          path: '/onboardingCopy',
