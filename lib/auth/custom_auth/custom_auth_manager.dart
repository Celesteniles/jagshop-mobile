...
class CustomAuthManager {
  ...
  Future signOut() async {
    ...
    jAGShopAuthUserSubject.add(
      JAGShopAuthUser(loggedIn: false),
    );
    persistAuthData();
  }

  Future<JAGShopAuthUser?> signIn({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
  ...
  JAGShopAuthUser? _updateCurrentUser({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
    ...
    final updatedUser = JAGShopAuthUser(
      loggedIn: true,
      uid: authUid,
    );
    jAGShopAuthUserSubject.add(updatedUser);
    persistAuthData();
    return updatedUser;
  }
