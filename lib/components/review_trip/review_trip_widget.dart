                  ...
                  children: [
                    Expanded(
                      child: Padding(
                        ...
                        child: Text(
                          FFLocalizations.of(context).getText(
                            'vdbsn9dd' /* Let us know what you thought o... */,
                          ),
                          textAlign: TextAlign.start,
                          style:
                    ...
                    children: [
                      Expanded(
                        child: Padding(
                          ...
                          child: Text(
                            FFLocalizations.of(context).getText(
                              'lcq683xd' /* How would you rate it? */,
                            ),
                            textAlign: TextAlign.start,
                            style:
                  ...
                  child: TextFormField(
                    ...
                    decoration: InputDecoration(
                      hintText: FFLocalizations.of(context).getText(
                        '6kzh7y12' /* Please leave a description of ... */,
                      ),
                      hintStyle:
                          FlutterFlowTheme.of(context).bodyMedium.override(
                                fontFamily: 'DM Sans',
